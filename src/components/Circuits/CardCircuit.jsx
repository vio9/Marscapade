...
export default function CardCircuit ({id, circuitName, picture, distance, duration, difflevel}) {
    return (
        <div className="cardCircuit">
                ...
                <p className="infosCircuit"><i className="fas fa-user-astronaut" style={{color:"#bd4f35"}}></i> Distance : {distance}</p>
                <p className="infosCircuit"><i className="fas fa-stopwatch" style={{color:"#bd4f35"}}></i> Duration : {duration}</p>
                <p className="infosCircuit"><i className="fas fa-rocket" style={{color:"#bd4f35"}}></i> Difficulty level : {difflevel}</p>
